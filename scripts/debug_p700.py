...
config = {
    ...
    "env": {
        "light_schedule": [
            {"start_time": 0, "end_time": 500, "intensity": 800}
        ]
    },
    "quantum": {"p700_threshold": 0.8, "decoherence_rate": 0.01},
    "bio": {
...
print(f"\nFinal State at t={log[-1]['time']}:")
print(f"Light Intensity: {log[-1]['light_intensity']}")
print(f"P700 Concentration: {log[-1]['p700_concentration']:.4f}")
