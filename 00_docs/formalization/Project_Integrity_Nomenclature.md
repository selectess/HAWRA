...
- **PhytoQMML** (Phyto-Quantum Metabolic Machine Learning) : Cadre d'apprentissage automatique supervisé utilisant les flux métaboliques comme vecteurs d'optimisation et la cohérence quantique comme fonction de coût.
...
- Configuration Entraînement (PhytoQMML):
  - `config.training`:
